...
%%% Purpose : Compress and Decompress DNS packets
%%% Created : 2007-01-06
%%% Updated : 2007-01-11
%%% Note    : This implimentation is currently in BETA. The routines decompress
%%%         : and recompress the root server packets without problems, but 
%%%         : more testing is needed in real world situations.
%%%----------------------------------------------------------------------
-module(dns_compress).
-include("dns.hrl").
